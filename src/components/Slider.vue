<template>
    <div id="slider">
        <div class="mate_line">
            ...
            <span class="slider"  @touchstart="touchSlider" @touchmove='moveSlider' @touchend='endSlider' ></span>
            <span class="slider" v-if="mode=='double'"  @touchstart="touchSlider" @touchmove='moveSlider' @touchend='endSlider' ></span>
        </div>
    </div>
</template>
...
export default {
    ...
    store,
    props: ["sliderMin","sliderMax","step","mode"],
    mounted(){
